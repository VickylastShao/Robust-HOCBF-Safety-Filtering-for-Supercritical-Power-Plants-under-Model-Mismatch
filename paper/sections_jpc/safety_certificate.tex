...
\textbf{Step 1 (GP calibration):} By Assumptions~\ref{asm:rkhs}--\ref{asm:gp_calibration} and the PAC-Bayes bound~\eqref{eq:gp_bound}, $|\Delta \hat{f}_j(x)| \leq \beta \sigmaGPj{j}(x)$ holds simultaneously for all $j$ w.p.\ $\geq 1-\delta$.
