...
\end{align}
Here $r_{j,k+1}$, $\mu_j$, $\sigma_j$, and $\sigma_{n,j}$ all have residual-rate units. Because the deployed sampling period is $T_s=1$\,s, this notation correction does not change the reported numerical thresholds.
