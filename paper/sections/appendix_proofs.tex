...
\end{equation}
where $u_{\max} = \sup_{u \in \calU} \|u\|$. This term is evaluated separately for each barrier row and included in that row's total margin; Theorem~1 does not assume a fixed ratio between $\sigma_{\mathrm{ctrl}}$ and $\sigmatotal$.
