...
\begin{enumerate}
    ...
    \item \textbf{Commissioning-calibrated robustness factor.} The scalar factor $\epsilon_\kappa$ interpolates between mean-corrected operation and the full implemented uncertainty margin, with diagnostics that select the smallest setting passing safety and feasibility gates, including the mean-only endpoint when no positive fraction is supported.
